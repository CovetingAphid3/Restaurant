<template>
  <div class="font-sans">
    ...
    <!-- Mobile Menu -->
    <div v-if="mobileMenuOpen" class="md:hidden fixed inset-0 bg-red-900 bg-opacity-95 z-40 flex items-center justify-center">
    ...
    <div class="relative h-screen flex items-center justify-center overflow-hidden bg-cover bg-center" style="background-image: url('/assets/burger.jpg');">
      ...
      <div class="relative z-10 text-center text-white max-w-4xl px-6">
        ...
        <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          <RouterLink to="/menu" class="bg-yellow-400 text-red-900 px-8 py-4 rounded-full text-xl font-bold hover:bg-yellow-500 transition duration-300 transform hover:scale-105 shadow-lg">Explore Our Menu</RouterLink>
    ...
    <section id="featured" class="py-24 bg-white">
      <div class="container mx-auto px-6">
        <h2 class="text-5xl font-bold text-center mb-16 font-serif">Our Royal Selection</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div v-for="burger in featuredBurgers" :key="burger.name" class="bg-white rounded-lg shadow-xl overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div class="p-6 text-center">
              <h3 class="text-2xl font-bold mb-2 font-serif">{{ burger.name }}</h3>
              ...
              <button class="bg-yellow-400 text-red-900 px-6 py-2 rounded-full font-bold hover:bg-yellow-500 transition duration-300 shadow-md">Add to Cart</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container mx-auto px-6">
        <div class="flex flex-col md:flex-row items-center">
          ...
          <div class="md:w-1/2 md:pl-12">
            ...
            <RouterLink to="/about" class="inline-block bg-yellow-400 text-red-900 px-8 py-4 rounded-full text-xl font-bold hover:bg-yellow-500 transition duration-300 shadow-lg">Discover Our Journey</RouterLink>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="testimonials" class="py-24 bg-gray-100">
      <div class="container mx-auto px-6">
        <h2 class="text-5xl font-bold text-center mb-16 font-serif">What Our Customers Say</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div v-for="testimonial in testimonials" :key="testimonial.name" class="bg-white p-8 rounded-lg shadow-xl">
            <div class="flex items-center mb-4">
              <img :src="testimonial.avatar" :alt="testimonial.name" class="w-16 h-16 rounded-full mr-4 border-2 border-yellow-400" />
              <div>
    ...
    <section id="promotions" class="py-24 bg-gradient-to-b from-red-900 to-black text-white">
      <div class="container mx-auto px-6 text-center">
        ...
        <RouterLink to="/menu" class="bg-yellow-400 text-red-900 px-10 py-4 rounded-full text-xl font-bold hover:bg-yellow-500 transition duration-300 shadow-lg transform hover:scale-105">Claim Your Royal Treat</RouterLink>
      </div>
    </section>
